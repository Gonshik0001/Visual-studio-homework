...
test('calculateBonus returns 50 when sum is greater than 50', () => {
  expect(calculateBonus(28, 35)).toBe(63);
});
...
test('calculateBonus returns 0 when one of the numbers is negative', () => {
  expect(calculateBonus(-10, 60)).toBe(50);
});
